...
(function () {
  ...
  autoplaySpeed: 1000, // Speed of autoplay transition (in ms)
  smartSpeed: 1000, // Speed of navigation or drag transitions
...
(function () {
            ...
            var carousels = function () {
                $(".owl-carousel-gallery").owlCarousel({
                    ...
                    nav: false,
                    dots: true,
                     autoplayTimeout: 2000, // Optional: time between slides
                    autoplaySpeed: 500, // Speed of autoplay transition (in ms)
                    smartSpeed: 500, // Speed of navigation or drag transitions
                    responsive: {
                        0: {
                            items: 3,
                            nav: false,
...
$(document).ready(function () {
  $(".owl-carousel").owlCarousel({
    ...
    dots: false,            
    autoplay: true,   
    autoplayTimeout: 5000, // Optional: time between slides
  autoplaySpeed: 1000, // Speed of autoplay transition (in ms)
  smartSpeed: 1000, // Speed of navigation or drag transitions
    responsive: {
      0: {
...
// featured-case-study-owl
$(document).ready(function () {
  $(".featured-case-study-owl").owlCarousel({
    items: 1,              
    loop: true,           
    margin: 10,           
    nav: true,             
